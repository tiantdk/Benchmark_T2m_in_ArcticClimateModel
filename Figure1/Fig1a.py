...
#Link to the original script:  https://github.com/mikarant/arctic-amplification.
...
# save data
file_npz = 'fig1a_mean_map_'+ ff + '_' +str(syear) + '-' + str(eyear) + '.npz'
...
plt.savefig('fig1a_map_'+ ff + '_' +str(syear) + '-' + str(eyear) + '.png',dpi=200,bbox_inches='tight')
